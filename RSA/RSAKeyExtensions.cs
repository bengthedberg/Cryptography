...
namespace RSA
{
    ...
    {
        //#region JSON
        //internal static void FromJsonString(this RSACryptoServiceProvider rsa, string jsonString)
        //{
        ...
        //internal static string ToJsonString(this RSACryptoServiceProvider rsa, bool includePrivateParameters)
        //{
